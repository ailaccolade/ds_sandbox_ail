...
def run_tests_Iris(path, categorical_cols, num_cols, full_cols): 
...
Iris_n_cols = 6
Iris_full_cols = ['Species', 'Sepal.Length', 'Sepal.Width', 'Petal.Length']
run_tests_Iris(Iris_pth, Iris_Cats_list, Iris_n_cols, Iris_full_cols)
...
run_tests_Session(Sess_pth, Sess_full_cols, Sess_num_cols, Sess_full_cols)
